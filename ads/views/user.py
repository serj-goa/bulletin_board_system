...
from ads.serializers import UserSerializer, UserCreateSerializer, UserUpdateSerializer #, UserAdSerializer
...
def user_ad_detail_view(request):
    user_qs = User.objects.prefetch_related("address").annotate(total_ads=Count('ad', filter=Q(ad__is_published=True)))
    ...
    for user in page_obj:
        users.append(user.json_representation)
